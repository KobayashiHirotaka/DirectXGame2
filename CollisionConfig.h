...
const uint32_t kCollisionAttributeItem1 = 0b01000;
const uint32_t kCollisionAttributeItem2 = 0b000010;
...
const uint32_t kCollisionMaskItem1 = 0b00001;
const uint32_t kCollisionMaskItem2 = 0b000001;
